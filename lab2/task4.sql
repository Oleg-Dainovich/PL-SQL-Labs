...
BEGIN
	IF INSERTING THEN
		INSERT INTO STUDENTS_LOG (LOG_DATE, OPERATION, NEW_STUDENT_ID, NEW_NAME, NEW_GROUP_ID)
		VALUES (SYSTIMESTAMP, 'INSERT', :NEW.ID, :NEW.NAME, :NEW.GROUP_ID);
	ELSIF UPDATING THEN
		INSERT INTO STUDENTS_LOG (LOG_DATE, OPERATION, OLD_STUDENT_ID, NEW_STUDENT_ID, OLD_NAME, NEW_NAME, OLD_GROUP_ID, NEW_GROUP_ID)
		VALUES (SYSTIMESTAMP, 'UPDATE', :OLD.ID, :NEW.ID, :OLD.NAME, :NEW.NAME, :OLD.GROUP_ID, :NEW.GROUP_ID);
	ELSIF DELETING THEN
		INSERT INTO STUDENTS_LOG (LOG_DATE, OPERATION, OLD_STUDENT_ID, OLD_NAME, OLD_GROUP_ID)
